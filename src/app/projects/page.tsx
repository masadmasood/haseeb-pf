  ...
  return (
    <>
      <div className="relative min-h-screen w-full bg-background overflow-hidden">
        {/* Radial Gradient */}
        <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_800px_at_50%_0px,hsl(var(--primary)/0.08),transparent)]"></div>
        ...
        <section className="pt-32 pb-20 md:pt-48 md:pb-32 relative z-10">
            ...
            <h1 className="font-sans font-bold text-6xl md:text-8xl lg:text-9xl tracking-tighter mb-8 text-foreground uppercase">
                Selected
                <span className="ml-2 block text-primary md:text-foreground">Works</span>
            </h1>
        ...
        <section className="py-20 relative z-10">
            <div className="container mx-auto px-6 max-w-7xl">
                ...
                {projectsData.map((project, index) => (
                    <div key={project.href} className="group grid lg:grid-cols-2 gap-12 items-center">
